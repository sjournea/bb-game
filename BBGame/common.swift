...
let SELECTION_BUTTON_WIDTH:CGFloat = 35.0
let SELECTION_BUTTON_HEIGHT:CGFloat = 35.0
let SELECTION_BUTTON_SPACING:CGFloat = 9.0
let SELECTION_BUTTON_EDGE:CGFloat = 4.5

let SELECTION_DEFAULT_COLOR = SKColor.grayColor()
let SELECTION_ACTIVE_COLOR = SKColor.redColor()
let SELECTION_USED_COLOR = SKColor.orangeColor()
